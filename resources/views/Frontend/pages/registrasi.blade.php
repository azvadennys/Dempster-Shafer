...
@section('content-wrapper')
    <div class="row justify-content-center">
            <div class="card col-6 my-5 login-session ">
                <div class="card-body">
                    <h4 class="card-title text-center text-custom mb-4">Registrasi</h4>
                ...
                @endif
                    ...
                    <form action="{{ URL::to('registrasi') }}" method="POST">
                        @csrf
                        <div class="mb-3">
                            <label for="name" class="form-label text-custom">Nama</label>
